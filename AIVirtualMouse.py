...
def virt_mouse_main():
    print("Info: Move hand to controll mouse position, \n"
          "      Connect thumd and middle thinger to press left button, \n"
          "      Thumb up to press right button, \n"
          "      If index thinger and little thinger are close, it moves page up, \n"
          "      If index thinger and little thinger are far, it moves page down \n"
          "Press esc to exit \n"
          "©nerklion, 2021")
